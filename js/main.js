...
function init(ile){
	...
	for(var i=1;i<=ile;i++){
		...
		$("#board").append('<div class="card shown" data-id="'+tmpArray[randomKey]+'"><div class="front" style="background:url(\'photos/'+tmpArray[randomKey]+'.png\')"></div><div class="back"></div></div>');
